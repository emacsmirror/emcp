...
# begin:tools
*** =apropos= [[./emcp-tools.el::38][~emcp-tools-apropos~]]
:PROPERTIES:
...
*** =describe= [[./emcp-tools.el::192][~emcp-tools-describe~]]
:PROPERTIES:
...
*** =eval= [[./emcp-tools-eval.el::310][~emcp-tools-eval~]]
:PROPERTIES:
:CUSTOM_ID: tool-eval
:END:
...
*** =find-definition= [[./emcp-tools.el::149][~emcp-tools-find-definition~]]
:PROPERTIES:
...
*** =get-variable= [[./emcp-tools.el::280][~emcp-tools-get-variable~]]
:PROPERTIES:
...
*** =info-search= [[./emcp-tools.el::249][~emcp-tools-info-search~]]
:PROPERTIES:
...
*** =screenshot= [[./emcp-tools.el::327][~emcp-tools-screenshot~]]
:PROPERTIES:
...
*** =send-keys= [[./emcp-tools-send-keys.el::177][~emcp-tools-send-keys~]]
:PROPERTIES:
...
*** =set-variable= [[./emcp-tools.el::296][~emcp-tools-set-variable~]]
:PROPERTIES:
