...
# begin:prompts
*** =/screenshot= [[./emcp-prompts.el::35][~emcp-prompt-screenshot~]]
:PROPERTIES:
...
# begin:tools
*** =apropos= [[./emcp-tools.el::39][~emcp-tools-apropos~]]
:PROPERTIES:
...
*** =describe= [[./emcp-tools.el::311][~emcp-tools-describe~]]
:PROPERTIES:
...
*** =find-definition= [[./emcp-tools.el::150][~emcp-tools-find-definition~]]
:PROPERTIES:
...
*** =find-references= [[./emcp-tools.el::265][~emcp-tools-find-references~]]
:PROPERTIES:
...
*** =get-variable= [[./emcp-tools.el::399][~emcp-tools-get-variable~]]
:PROPERTIES:
...
*** =info-search= [[./emcp-tools.el::368][~emcp-tools-info-search~]]
:PROPERTIES:
...
*** =screenshot= [[./emcp-tools.el::446][~emcp-tools-screenshot~]]
:PROPERTIES:
...
*** =set-variable= [[./emcp-tools.el::415][~emcp-tools-set-variable~]]
:PROPERTIES:
...
** [[./emcp-tools.el::255][~emcp-tools-find-references-max-lines~]]
:PROPERTIES:
