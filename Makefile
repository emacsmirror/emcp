...
EL_FILES = emcp-uri.el emcp-core.el emcp-confirm.el emcp-http.el emcp-prompts.el emcp-resources.el emcp-tools.el emcp-tools-eval.el emcp-tools-send-keys.el emcp.el
